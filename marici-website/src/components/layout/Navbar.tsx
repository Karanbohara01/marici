        ...
        <>
            <header
                className={`fixed top-0 w-full z-50 transition-all duration-500 navbar-glow ${scrolled
                    ? "bg-background/90 backdrop-blur-lg border-b border-slate-200/70 scrolled py-3 shadow-sm"
            ...
            >
                <div className="container mx-auto px-6 flex items-center justify-between max-w-7xl">
                    ...
                    <div className="hidden lg:flex items-center gap-6 shrink-0">
                        <Link
                            href="/contact"
                            className={`nav-link text-[12px] font-bold uppercase tracking-[0.2em] transition-colors ${isActive("/contact") ? "text-blue-600" : "text-slate-600 hover:text-slate-900"
                                }`}
                        >
                            Contact
                        </Link>
                    ...
                    {/* Mobile Menu Toggle */}
                    <button
                        className="lg:hidden relative z-50 text-slate-700 p-2.5 rounded-xl hover:bg-slate-100 transition-all duration-300"
                    ...
                    >
                        ...
                        <div className="flex-1 flex flex-col justify-center px-8 -mt-12">
                            {navLinks.map((link, index) => (
                                ...
                                >
                                    <Link
                                        ...
                                        className={`group flex items-center justify-between py-4 text-xl font-display font-bold tracking-wide transition-all duration-300 ${isActive(link.href)
                                            ? "text-blue-600 mobile-link-active"
                            ...
                            <motion.div
                                ...
                                className="mt-2"
                            >
                                <div className="h-px bg-gradient-to-r from-slate-200 via-slate-100 to-transparent mb-2" />
                                <Link
                                    href="/contact"
                                    onClick={() => setMobileMenuOpen(false)}
                                    className={`group flex items-center justify-between py-4 text-xl font-display font-bold tracking-wide transition-all duration-300 ${isActive("/contact")
                                        ? "text-blue-600 mobile-link-active"
                                        : "text-slate-700 hover:text-slate-900"
                                        }`}
                                >
                        ...
                        >
                            ...
                            <p className="text-center text-slate-400 text-xs mt-4 tracking-wide">
