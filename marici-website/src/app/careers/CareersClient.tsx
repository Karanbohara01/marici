    ...
    return (
        <main className="min-h-screen bg-background">
                ...
                <div className="container mx-auto px-6 relative z-10 max-w-7xl">
                    <div className="max-w-4xl">
                        ...
                        <motion.p
                            ...
                            className="text-slate-500 leading-relaxed max-w-3xl font-medium"
                        >
            ...
            <div className="container mx-auto px-6 max-w-7xl py-20 pb-32">
                        ...
                        >
                            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-12">
                                <div className="space-y-8">
                                    <div className="flex flex-wrap items-center gap-8 text-[11px] text-slate-500 font-bold uppercase tracking-[0.2em]">
                                        <span className="bg-slate-100 px-4 py-1.5 border border-slate-200 rounded-lg text-blue-600">{job.department}</span>
                                    ...
                                    <h2 className="font-black tracking-tight text-foreground group-hover:text-blue-600 transition-colors uppercase leading-tight">
                                        {job.title}
                                    </h2>
                ...
                {careers.length === 0 && (
                    <div className="py-40 text-center border border-dashed border-slate-200 rounded-3xl bg-slate-50">
                ...
                <div className="mt-20 p-12 md:p-20 bg-slate-50 border border-slate-200 rounded-3xl relative overflow-hidden group">
                    <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-16">
                        <div className="max-w-2xl text-center lg:text-left">
                            <h3 className="font-black tracking-tighter mb-6 text-foreground uppercase leading-tight">Unlisted <br /><span className="text-gradient">roles</span></h3>
                            <p className="text-slate-500 mb-0 leading-relaxed font-medium">
                ...
                {isModalOpen && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-10">
                        ...
                        <motion.div
                            ...
                            className="bg-white w-full max-w-4xl max-h-[90vh] overflow-y-auto relative z-10 shadow-3xl border border-slate-200 rounded-3xl flex flex-col"
                        >
                            <div className="sticky top-0 bg-white/90 backdrop-blur-xl border-b border-slate-200 p-8 md:p-10 flex items-center justify-between z-10">
                                <div>
                                    <h2 className="font-black tracking-tighter text-foreground uppercase leading-tight mb-3">Apply for Position</h2>
                                    <p className="text-[11px] font-bold uppercase tracking-[0.3em] text-blue-400">{selectedJob?.title} — {selectedJob?.location}</p>
                                </div>
                                <button
                                    onClick={() => setIsModalOpen(false)}
                                    className="p-3 bg-slate-100 text-slate-500 hover:text-foreground rounded-full transition-all"
                                >
                                    <X className="w-6 h-6" />
                                </button>
                            </div>
                            ...
                            <div className="p-8 md:p-12">
                                {submitted ? (
                                    <div className="py-24 text-center space-y-10">
                                        ...
                                        <div>
                                            <h3 className="font-black tracking-tighter text-foreground uppercase mb-4">Application Sent!</h3>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-12">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                            <div className="space-y-4">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-white border border-slate-200 rounded-xl p-5 text-base text-foreground focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 transition-all font-medium placeholder:text-slate-400"
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    />
                                                    <div className="w-full bg-white border border-slate-200 rounded-xl p-5 text-base flex items-center justify-between text-slate-500 font-medium">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <textarea
                                                ...
                                                className="w-full bg-white border border-slate-200 rounded-xl p-5 text-base text-foreground focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 transition-all font-medium resize-none placeholder:text-slate-400"
